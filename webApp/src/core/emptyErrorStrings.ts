...
export const EMPTY = {
  ...
  HOME_TITLE: "Tu inicio está vacío",
  HOME_SUBTITLE: "Empieza siguiendo personas o publicando tu primer café.",
  HOME_NO_POSTS: "No hay publicaciones disponibles",
  HOME_NO_POSTS_SUB: "Publica tu primer café o sigue a más personas.",
