/**
 * Botón custom "Registrarse con Google" al estilo X (Twitter):
 * fondo blanco, borde gris claro, logo G de Google, texto. No usa el iframe de Google.
...
export interface GoogleSignInButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  /** Texto del botón */
  label?: string;
  /** Si true, muestra estado de carga */
  loading?: boolean;
}
