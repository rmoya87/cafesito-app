...
| `I18N_IDIOMA_WEBAPP_ANDROID.md` | **Idioma de app Web/Android:** selector en perfil, opción Sistema (primera), idiomas soportados (`es/en/fr/pt/de`), fallback a inglés si el idioma del sistema no está soportado. |
