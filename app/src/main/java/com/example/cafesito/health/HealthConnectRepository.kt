package com.example.cafesito.health

import android.content.SharedPreferences
import com.example.cafesito.health.HealthConnectManager
...
class HealthConnectRepository @Inject constructor(
    ...
    suspend fun readAndSyncExternalData(): List<Pair<Int, Long>> {
        ...
        // Filter out records created by Cafesito itself to avoid sync loops
