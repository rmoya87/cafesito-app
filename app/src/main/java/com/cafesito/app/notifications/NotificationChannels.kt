...
object NotificationChannels {
    ...
    const val CHANNEL_BREW_TIMER = "cafesito_brew_timer_v3"
    ...
    fun ensureCreated(context: Context) {
        ...
        val channels = listOf(
            ...
            NotificationChannel(CHANNEL_BREW_TIMER, "Timer de elaboración", NotificationManager.IMPORTANCE_DEFAULT).apply {
